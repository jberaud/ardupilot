...
#define HAL_FLOW_PX4_BOTTOM_FLOW_HIST_FILTER 0
#define HAL_FLOW_PX4_BOTTOM_FLOW_GYRO_COMPENSATION 0
#define HAL_FLOW_PX4_GYRO_COMPENSATION_THRESHOLD 0.01
/* focal length 3.6 um, 2x binning in each direction */
#define HAL_FLOW_PX4_FOCAL_LENGTH_PX (2.5 / (3.6 * 2) * 1000.0f)
